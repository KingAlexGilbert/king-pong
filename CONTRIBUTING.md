# Contributing to King Pong

Thanks for your interest in contributing to King Pong.

King Pong is a personal open-source project, but bug reports, suggestions, testing feedback, and improvements are welcome.
...
Please keep King Pong's core identity in mind:
...
Large rewrites should be discussed first through an issue.
...
King Pong should stay easy to play, easy to understand, and true to its retro arcade style.

New features are welcome, but they should not make the project unnecessarily complicated or break the core gameplay feel.
